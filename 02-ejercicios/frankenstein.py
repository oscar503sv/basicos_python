# Mostrar en pantalla el numero de veces
# que se repite la palabra Frankentein.

frankenstein_texto = "I am by birth a Genevese, and my family is one of the most distinguished\
...
# Separamos todas la palabras del texto
# y las almacenamos en una variable (lista).
palabras = frankenstein_texto.split()
palabras_repetidas = []

# Recorremos la lista y contamos el numeros de
# veces que se repite con metodo .count() a la misma vez
# las almacenamos en forma minuscula con .lower()
for palabra in palabras:
    palabras_repetidas.append(palabras.count(palabra.lower()))

# buscamos la palabra que mas se repite con max()
palabra_mayor = max(palabras_repetidas)
# buscamos el indice de la palabra
indice_de_palabra_repetida = palabras_repetidas.index(palabra_mayor)

palabra_que_se_repite = palabras[indice_de_palabra_repetida]

print(f"El numero de veces que se repite una palabra es: {palabra_mayor}.")
print(f"La palabra que mas se repite es: '{palabra_que_se_repite}'")